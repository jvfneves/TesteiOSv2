## Vitor Neves - Accenture

### Passos para Executar o projeto
Para executar o projeto, será nescessario o clone do mesmo, após deve ser executado o comando `` pod install `` no terminal para fazer os downloads das dependencias.
